...
The project uses **HashMap** to store and manage multiple bank accounts efficiently.
...
- Simple menu-driven programs for interaction
...
3. **Withdraw Money** – Withdraw money if sufficient balance is available.  
4. **Check Balance** – View account holder’s details and current balance.  
